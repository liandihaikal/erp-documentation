...
| [Visit Type](#5-visit-type) | `/admin/visit-type` | `read-visit-type` | Jenis-jenis kunjungan sales (untuk [[12. CRM]]) |
...
| [Table](#17-table) | `/admin/table` | `read-table` | Data meja (untuk [[14. POS]]) |
...
## 1. Bank
**Fungsi:** Data rekening bank perusahaan, dipakai di [[7. Finance|Keuangan]] & pembayaran.
...
## 3. Vendor & Customer
**Fungsi:** Data supplier (vendor) dan pelanggan (customer), dipakai di [[3. Procurement|Pengadaan]], [[4. Sales|Penjualan]], [[12. CRM]].
...
## 4. PIC
**Fungsi:** Data penanggung jawab (person in charge), biasanya terhubung ke Department dan dipakai di [[12. CRM]]/[[3. Procurement|Pengadaan]].
...
## 5. Visit Type
**Fungsi:** Jenis-jenis kunjungan sales (misal: Kunjungan Rutin, Follow Up, Penagihan), dipakai di [[12. CRM#1. Visit|CRM > Visit]].
...
## 6. Vehicle Type
**Fungsi:** Jenis kendaraan operasional, dipakai di [[4. Sales#4. Shipping Order|Sales > Shipping Order]].
...
## 9. Location
**Fungsi:** Data lokasi fisik (gudang, cabang, outlet), dipakai luas di [[6. Inventory|Inventaris]], [[3. Procurement|Pengadaan]], [[4. Sales|Penjualan]].
...
## 10. Cost
**Fungsi:** Data jenis-jenis biaya (misal: Biaya Transport, Biaya Entertain), dipakai di [[12. CRM#2. Sales Expense|CRM > Sales Expense]] atau [[7. Finance|Keuangan]].
...
## 14. Payment Method
**Fungsi:** Metode pembayaran yang tersedia (Tunai, Transfer, QRIS, Kartu Debit/Kredit), dipakai di [[14. POS]], [[4. Sales|Penjualan]], [[7. Finance|Keuangan]].
...
## 17. Table
**Fungsi:** Data meja untuk bisnis F&B, dipakai di [[14. POS#2. Table Layout|POS > Table Layout]].
...
- **Item/Service** dipakai di [[3. Procurement|Pengadaan]], [[4. Sales|Penjualan]], [[6. Inventory|Inventaris]], [[5. Production|Produksi]].
- **Vendor & Customer** dipakai di [[3. Procurement|Pengadaan]] (vendor) dan [[4. Sales|Penjualan]] & [[12. CRM]] (customer).
- **Table** dipakai di [[14. POS]].
- **Bank** & **Payment Method** dipakai di [[7. Finance|Keuangan]].
