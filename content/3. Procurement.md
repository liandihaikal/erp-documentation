...
3. Kirim untuk disetujui — PR akan muncul di [[10. Approval-Request|Permintaan Persetujuan]] milik atasan terkait.
...
3. Pilih vendor ([[2. Master-Data#Vendor & Customer|Master Data]]), konfirmasi harga & termin pembayaran.
...
3. Simpan — stok otomatis bertambah di [[6. Inventory|Inventaris]].
...
3. Simpan — akan tercatat sebagai utang di [[7. Finance|Keuangan]].
...
2. Pilih faktur yang mau dibayar, isi jumlah & metode pembayaran ([[2. Master-Data#Payment Method|Master Data]]).
3. Simpan — status utang berubah menjadi lunas/sebagian.

## Keterkaitan dengan Modul Lain
- Goods Receipt → menambah stok di [[6. Inventory|Inventaris]].
- Faktur Pembelian & Pembayaran → tercatat di [[7. Finance|Keuangan]] dan bermuara ke [[8. Accounting|Akuntansi]] sebagai jurnal utang.
