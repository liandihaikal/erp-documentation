...
## 1. Quotation
**Fungsi:** Membuat penawaran harga untuk customer/prospek, biasanya hasil tindak lanjut dari [[12. CRM#1. Visit|kunjungan sales]].

**Langkah Umum:**
1. Buka **Penjualan > Quotation**.
2. Pilih customer ([[2. Master-Data#Vendor & Customer|Master Data]]), tambahkan item & harga.
...
3. Simpan — stok otomatis berkurang di [[6. Inventory|Inventaris]].
...
2. Buat perintah kirim dari SO/Goods Issued, pilih kendaraan ([[2. Master-Data#Vehicle Type|Master Data]]) dan tujuan.
...
3. Simpan — tercatat sebagai piutang di [[7. Finance|Keuangan]].
...
- Goods Issued → mengurangi stok di [[6. Inventory|Inventaris]].
- Faktur Penjualan & Pembayaran → tercatat di [[7. Finance|Keuangan]] dan bermuara ke [[8. Accounting|Akuntansi]] sebagai jurnal piutang.
- Quotation biasanya hasil tindak lanjut dari [[12. CRM|CRM]].
